...
export const metadata: Metadata = {
  title: 'Murtaza Fetrat Portfolio Website', // عنوان سایت
  description: 'Welcome to my awesome Next.js app', // توضیحات سایت
  keywords:
    'Welcome to the portfolio website of Murtaza Fetrat, showcasing web development projects and skills.', // کلمات کلیدی
};
