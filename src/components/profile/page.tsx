...
import {FaCode, FaLinkedinIn, FaMobileAlt, FaTelegram} from 'react-icons/fa';
import {MdOutlineMail} from 'react-icons/md';
import {IoLocationSharp} from 'react-icons/io5';
import {PiDownloadLight} from 'react-icons/pi';
import sadeq from '../../../public/images/mnasim.jpg';
  ...
  return (
    <div className="flex flex-col bg-white m-5 mt-10 lg:mt-40 rounded-[18px] justify-center items-center p-5 lg:justify-start dark:bg-gray-800">
      ...
      <div className=" text-2xl md:text-3xl lg:text-xl lg:mt-20 dark:text-gray-200">
        <p className="font-robotoslab">Mohammad Nasim Moradi</p>
      </div>
      ...
      <div className="flex flex-row w-[12rem] h-[2rem] mb-5 justify-around ">
        <div>
          <a
            href="https://t.me/mohammadNasimMoradi"
            rel="noopener noreferrer"
            target="_blank"
          >
            <SocialCard
              icon={
                <FaTelegram className="text-blue-500 dark:text-blue-600 md:text-xl lg:text-sm" />
              }
        ...
        <div>
          <a
            href="https://github.com/Moh-Nasim-Moradi"
            rel="noopener noreferrer"
            target="_blank"
          >
            <SocialCard
        ...
        <div>
          <a
            href="https://www.linkedin.com/in/murtazafetrat0012/"
            rel="noopener noreferrer"
            target="_blank"
          >
            <SocialCard
      ...
      <div className="bg-gray-100 dark:bg-gray-700 mb-5 flex flex-col ml-8 mr-8 w-full rounded-2xl justify-items-start lg:m-0">
        <div className="flex flex-row items-center m-2 mb-1 ">
          ...
          />
          <PersonalDetailCard title="Phone" detail="+91 768301660" />
        </div>
        ...
        <div className="flex flex-row items-center m-3">
          ...
          <PersonalDetailCard
            title="Email"
            detail="monasimmoradi7@gmail.com"
          />
        </div>
        <hr className="h-px self-center w-[90%] bg-gray-300 border-0" />
        <div className="flex flex-row items-center m-3">
          <SocialCard
            ...
            className="bg-white dark:bg-slate-800 m-3 p-3 rounded-lg drop-shadow-xl"
          />
          <PersonalDetailCard title="Location" detail="Nayan Goan, Mohali " />
        </div>
        <hr className="h-px self-center w-[90%] bg-gray-300 border-0" />
        <div className="flex flex-row items-center m-3">
          <SocialCard
